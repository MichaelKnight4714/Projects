...
```{r}
atp_as_factor <- read_sav("./Datasets/ATP W14.sav", 
                    user_na = TRUE) %>%
  as_factor()
...
social_med_vs_trusts_people %>% 
  ...
  ggtitle("Figure 1: Average Amount of Trust In Others by \n Prefered Method of Getting News") + 
  theme_bw() +
...
social_med_freq_vs_trusts_people %>% 
  ...
  ylab("Average Amount of Trust In Others") +
  ggtitle("Figure 2: Average Amount of Trust In Others by \n Frequency of Social Media as News Intake") + 
  theme_bw() +
  theme(legend.position="none")
...
social_med_vs_trusts_natl_news_orgs %>% 
  ...
  ggtitle("Figure 3: Avg Amt of Trust In National News Orgs by \n News Preference") + 
  theme_bw() +
  theme(legend.position="none")
...
social_med_freq_vs_natl_news_orgs %>% 
  ...
  xlab("Frequency of Social Media as News Intake") + 
  ylab("Avg Amt of Trust In National News Orgs") +
  ggtitle("Figure 4: Avg Amt of Trust In National News Orgs by \n Frequency of Social Media") + 
  theme_bw() +
  theme(legend.position="none")
...
news_trust_v_fact_check %>% 
  ...
  ggtitle("Figure 5: Avg Amt of Trust In Social Media News by \n Frequency of Fact Checking") + 
  theme_bw() +
  theme(legend.position="none")
...
```{r}
Trust_data<-read.csv("./datasets/Trust_data.csv")
```
...
```{r}
Trust_data <- read.csv("./datasets/Trust_data.csv",header = TRUE)
```
